...
<?php 
	...
	$sql="insert into people(people,body,catelog_id,pic) values(:people,:body,:catelog_id,:dest_path);";
	...
	else
	{
		...
		$query=$db->prepare($sql);
		$query->bindvalue(':people_id',$id,pdo::PARAM_INT);
		...
		redirect_to("../search/show.php?id=$id");
	}
